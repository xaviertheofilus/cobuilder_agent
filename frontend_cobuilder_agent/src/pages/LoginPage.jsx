...
import { FiArrowRight, FiEye, FiEyeOff, FiLock, FiMail, FiMoon } from 'react-icons/fi';
    ...
    <div className={styles.page}>
      <section className={styles.left}>
        ...
        <div className={styles.form}>
          <Input label="Email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} icon={FiMail} />
          <Input
            label="Password"
            ...
            error={error}
            rightElement={
              <button type="button" className={styles.eye} onClick={() => setShowPass((value) => !value)}>
